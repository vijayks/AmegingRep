        ...
        <div class="body_part_wrapper">
            <div class="body_main_cont">
                <div class="body_top_menu_cont">
                    ...
                    <%--LOGO IMAGE--%>
                <div class="logo_cont">  <a title="Home" <c:if test="${sessionScope.button == 'home'}" >class="selected"</c:if> href="<c:if test="${city=='All India'}"><%=localUrlPath%></c:if><c:if test="${city!='All India'}"><%=localUrlPath%>/ccs-${city}</c:if>" ><div class="logo"></div></a> </div>
                <%--LOGO IMAGE--%>
