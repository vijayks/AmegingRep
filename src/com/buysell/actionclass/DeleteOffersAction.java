 ...
 * @author bbsadmin
 */
public class DeleteOffersAction extends org.apache.struts.action.Action {
    
    /* forward name="success" path="" */
    private static final String SUCCESS = "success";
    private static Logger LOG = Logger.getLogger(DeleteOffersAction.class);
    /**
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if(ub!=null) {
            ...
            ArrayList al = ds.getDeleteOffersList(dId);

            request.setAttribute("title", "Delete Offers");

            AdsResultsBean arb = new AdsResultsBean();
            arb.setResults(al);
            request.setAttribute("deleteOffersList", arb);
