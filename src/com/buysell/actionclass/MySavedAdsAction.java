 ...
 * @author bbsadmin
 */
public class MySavedAdsAction extends org.apache.struts.action.Action {

    /* forward name="success" path="" */
    private final static String SUCCESS = "success";
    private static Logger LOG = Logger.getLogger(MySavedAdsAction.class);
