 ...
 * @author bbsadmin
 */
public class MySavedAlertsAction extends org.apache.struts.action.Action {

    /* forward name="success" path="" */
    private final static String SUCCESS = "success";
    private static Logger LOG = Logger.getLogger(MySavedAlertsAction.class);
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        ArrayList al = as.getMySavedAlertss(ub, cu);
        request.setAttribute("mySavedAlerts", al);
