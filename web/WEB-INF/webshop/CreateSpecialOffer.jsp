...
<div class="verdana_form_post" style="width:730px">
    ...
    <c:if test="${fn:length(productsList)=='0'}">
        <center><span style="font-size:14px;color:red"><b> No product yet created .Hence , no list of Special Offer products </b></span></center>

    </c:if>

    <c:if test="${fn:length(productsList)!='0'}">

        <fieldset><legend style="color:#3366cc"><b>Special Offers</b></legend>
            ...
            <center><span style="color:green"><c:if test="${ok!=null}">
                ...
                <form name="assignWCT" action="assignWCT.do?m=in" method="POST" onsubmit="return pId(this)">
                    <table id="topNlist" style="margin-left:70px">
                        <tr style="vertical-align:middle">
                            <td>Products</td>
                            <td><select id="prod" name="prod" style="margin-left:10px" onchange="return hello(this)">
                ...
                <span style="margin-left:150px"><input type="submit" value="Assign"/></span><input type="hidden" name="lT" value="spl"/>
            </form>
        </fieldset>
        <br/>
        <br/>
        ...
        <fieldset>
            <legend style="color:#3366cc"><b>Existing Special Offers Products</b></legend>
                ...
                <c:if test="${assignList!=null}">
                    ...
                    <c:forEach items="${assignList}" var="pd">
                        <tr>
                            ...
                            <td><a href="delAssign.do?id=${pd.id}&lT=spl"><input type="button" value="Remove"/></a></td>
                        </tr>
