<%-- 
    Document   : astroServices
    Created on : Aug 19, 2009, 11:58:37 PM
    Author     : bbsadmin
--%>
...
<table class="verdana_form_postAd" align="left">
    ...
    <tr>
        ...
        <td>
            <textarea name="prefLocation" value="" cols="" rows=""><%=ab.getPrefLocation()%></textarea>
        </td>
    </tr>
...
<div class="tilepad" align="left">
   <table class="verdana_form_postAd" align="left">
    ...
    <tr>
        ...
        <td>
            <textarea name="prefLocation" value="" cols="" rows=""></textarea>
        </td>
    </tr>
